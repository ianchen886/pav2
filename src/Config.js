 ...
 * primarily sheet names and other static configuration values. These constants
 * are used by various modules throughout the project to ensure consistent referencing.
 */
